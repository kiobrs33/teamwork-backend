...
ALTER TABLE "competencia_detalle"
    ADD CONSTRAINT "competencia_detalle_id_competencia_fkey" FOREIGN KEY ("id_competencia") REFERENCES "competencia" ("id_competencia") ON DELETE RESTRICT ON UPDATE CASCADE;
